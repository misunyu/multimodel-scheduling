...
#
#
# def npu0_yolo_ready(o_path):
#     driver0 = NeublaDriver()
#     assert driver0.Init(0) == 0
#     assert driver0.LoadModel(o_path) == 0
#
#     process_npu0 = mp.Process(target=npu0_process_yolo_input(), args=(0,))
#     process_npu0.start()
#     process_npu0.join()
#
#     return 0
#
# def npu0_process_yolo_input(input_data):
#
#     assert driver0.SendInput(input_data) == 0
#     assert driver0.Launch() == 0
#     raw_outputs = driver0.ReceiveOutputs()
#
#     return raw_outputs
#
# def npu0_yolo_close(o_path):
#
#     assert driver0.Close() == 0
#     print("Multi-Antara Driver 0 closed successfully.")
#
#
...
#
#             output_gemm = (output_gemm - (dequant_act_zero_point * output_w_sum) - (
#                         dequant_weight_zero_point * output_a_sum) + (
#                                        dequant_act_zero_point * dequant_weight_zero_point)) * dequant_scale  # gemm + dequantize
