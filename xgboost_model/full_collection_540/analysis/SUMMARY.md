...
| P2 | 플랫폼별 최적 배치 불일치: **β=1.0에서 29/45**, β=0.5에서 30/45(기존 보고서 재현), β 민감 그룹 1개 |
...
6. **P2 점수는 원시 측정 총계** (원본 compare_platforms.py와 동일) — 30/45 연속성 확인이 목적이므로.
...
- P2: `scripts/compare_platforms_v2.py`, `analysis/platform_divergence.csv`, `analysis/platform_divergence.md`
