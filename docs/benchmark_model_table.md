...
|---|---|---:|---:|---:|
| YOLO11n | Detection | 11 | 5.07 | 25.4 |
| YOLO11s | Detection | 37 | 6.19 | 31.0 |
| YOLO11m | Detection | 77 | 8.36 | 41.8 |
| YOLO11l | Detection | 98 | 10.31 | 51.6 |
| YOLO11x | Detection | 218 | 13.07 | 65.3 |
| ResNet50 | Classification | 98 | 2.24 | 11.2 |
| MobileNet-v2 | Classification | 14 | 1.28 | 6.4 |
...
> **YOLO11n 보정(2026-07-22)**: 이전 6.89ms는 cold-GPU 첫 세션 아티팩트(측정 편향, H2). GPU 사전 워밍업 후 5.07ms로 보정, n<s<m<l<x 단조 회복. 상세 docs/latency_decomposition.md.
